...
*/
UCLASS()
class KNIGHTGUY_API UKGGameInstanceBase : public UGameInstance
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	void AddDefaultInventory(UKGSaveGame* SaveGame, bool bRemoveExtra = false);

	/** Returns true if this is a valid inventory slot */
	UFUNCTION(BlueprintCallable, Category = Inventory)
	bool IsValidItemSlot(FKGItemSlot ItemSlot) const;
	...
	UKGSaveGame* GetCurrentSaveGame();
...
public:
	...
	TMap<FPrimaryAssetId, FKGItemData> DefaultInventory;
